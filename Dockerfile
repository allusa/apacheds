...
RUN yum -y update && yum -y install java-1.7.0-openjdk openldap-clients nmap && curl -s http://mirrors.ukfast.co.uk/sites/ftp.apache.org//directory/apacheds/dist/2.0.0-M20/apacheds-2.0.0-M20-x86_64.rpm -o /tmp/apacheds.rpm \
